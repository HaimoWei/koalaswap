...
"""
闲鱼爬虫 - 第3部分 (OPPO & vivo手机)
目标：100个商品，40个用户
"""

from goofish_base import GoofishBaseScraper

class GoofishPart3(GoofishBaseScraper):
    def __init__(self):
    ...
    def run_scraping(self):
        ...
        # 第3部分关键词：OPPO和vivo手机
        keywords = [
            "OPPO手机", "OPPO Find", "OPPO Reno", "一加手机", "OnePlus",
            "vivo手机", "vivo X", "vivo S", "iQOO手机", "vivo NEX"
        ]
