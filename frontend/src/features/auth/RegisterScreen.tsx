...
export default function RegisterScreen() {
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            Alert.alert("注册成功", "已发送验证邮件，请查收并点击邮件中的链接进行验证。");
            nav.goBack();
        } catch (e: any) {
    ...
    return (
        <View style={{ flex:1, padding:16, gap:12 }}>
            ...
            <TextInput placeholder="邮箱" autoCapitalize="none" value={email} onChangeText={setEmail}
                       style={{ borderWidth:1, borderRadius:8, padding:10 }} />
            <TextInput placeholder="昵称" value={displayName} onChangeText={setDisplayName}
                       style={{ borderWidth:1, borderRadius:8, padding:10 }} />
